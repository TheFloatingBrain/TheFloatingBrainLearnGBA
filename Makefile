...
%.elf:
	@echo linking $(notdir $@)
	@$(LD)  $(LDFLAGS) $(OFILES) $(LIBPATHS) $(LIBS) -o C:/Users/TheFl/source/repos/LearnGBA/LearnGBA.elf
	##$@
...
INCLUDES	:= include resources $(DEVKITPRO)/libgba/include
DATA		:= data
MUSIC		:=
